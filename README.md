...
## Included Software Information (Version: 10781.19.0.1214)

| Field           | Value                                                               |
| :-------------- | :------------------------------------------------------------------ |
| Release         | **10781.19.0.1214**                                                 |
| Binary Location | Included in repository: `./bin/univpn-linux-64-10781.19.0.1214.zip` |
